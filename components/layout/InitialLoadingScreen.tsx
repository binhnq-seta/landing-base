...
export function InitialLoadingScreen() {
    ...
    return (
        <div
            aria-busy="true"
            aria-live="polite"
            className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden bg-neutral-950 px-6 transition-opacity duration-500"
        >
            ...
            <div className="relative z-10 flex w-full max-w-md flex-col items-center text-center">
                <div className="mb-8 flex items-center justify-center rounded-full border border-blue-400/20 bg-white/5 p-4 shadow-[0_0_80px_rgba(59,130,246,0.22)] backdrop-blur-md">
                    <div className="relative h-12 w-12">
                        ...
                        <div className="absolute inset-0 rounded-full border-2 border-transparent border-r-sky-300 border-t-blue-400 animate-spin" />
