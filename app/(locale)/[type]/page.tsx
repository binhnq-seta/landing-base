  ...
  return (
    <>
      ...
      <main className="pt-0">
        ...
        <PartnerSection data={content.partners} heading={content.sectionLabels.partners} headingSize={content.partnerHeadingSize} description={content.partnerDescription} />
      </main>
